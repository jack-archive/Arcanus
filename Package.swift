...
let package = Package(name: "Arcanus",
                      ...
                      dependencies: [.package(url: "https://github.com/SwiftyBeaver/SwiftyBeaver.git", from: "1.5.2"),
        ...
        */ ],
                      targets: [.target(name: "Arcanus", dependencies: ["SwiftyBeaver", "SigmaSwiftStatistics", "Socket",
